...
if (isset($_POST['add_product'])) {
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
        ...
        $query = "INSERT INTO products (name, price, stock, image, category_id) VALUES ('$name', '$price', '$stock', '$target_file', '$category_id')";
...
if (isset($_POST['update_product'])) {
    ...
    if ($_FILES["image"]["name"]) {
        ...
        $query = "UPDATE products SET name='$name', price='$price', stock='$stock', image='$target_file', category_id='$category_id' WHERE id='$id'";
    } else {
        // Update tanpa mengganti gambar
        $query = "UPDATE products SET name='$name', price='$price', stock='$stock', category_id='$category_id' WHERE id='$id'";
    }
    mysqli_query($conn, $query);
}

// Ambil data produk
$result = mysqli_query($conn, "SELECT products.*, categories.name as category_name FROM products LEFT JOIN categories ON products.category_id = categories.id");
?>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select name="category_id" class="form-control" required>
                <?php mysqli_data_seek($categories_result, 0); // Reset pointer kategori ?>
