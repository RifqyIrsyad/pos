...
// Mengambil data dari tabel orders dan menggabungkan dengan tabel customers
$result = mysqli_query($conn, "SELECT orders.*, customers.name AS customer_name FROM orders 
